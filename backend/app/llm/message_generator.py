...
def generate_messages(prospect_name):
    ...
    ethnicity = prospect_info.get("ethnicity", "")
    profession = prospect_info.get("profession", "")
    age = prospect_info.get("age", "")
    gender = prospect_info.get("gender", "")
    location = prospect_info.get("location", "")
    interests = prospect_info.get("interests", "")
    socials = prospect_info.get("socials", {})
    context_from_post = prospect_info.get("context_from_post", "")

    campaign_name = campaign_context.get("campaign_name", "")
    campaign_type = campaign_context.get("type", "")
    description = campaign_context.get("description", "")
    why_approaching = campaign_context.get("why_approaching", "")
